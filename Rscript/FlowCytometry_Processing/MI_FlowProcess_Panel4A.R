...
#P4.flow.data <- P4.flow.data[1:322]
P4.flow.data <- P4.flow.data[1:250]
...
write.table(all.cell.df,
            file="/mnt/scratcha/jmlab/morgan02/FACS/Milieu_Interieur/summary_files/Panel4A_summary.txt",
