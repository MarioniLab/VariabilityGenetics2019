...
P7.flow.data <- P7.flow.data[649:972]
#P7.flow.data <- P7.flow.data[649:740]
...
write.table(all.cell.df,
            file="/mnt/scratcha/jmlab/morgan02/FACS/Milieu_Interieur/summary_files/Panel7C_summary.txt",
