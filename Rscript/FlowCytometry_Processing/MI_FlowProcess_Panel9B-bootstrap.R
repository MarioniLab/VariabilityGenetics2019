...
P9.flow.data <- P9.flow.data[318:634]
...
# CD4+CCR6-CXCR3+ #
###################
# What T cell subset are these? CD4+ Th1?
ccr6.points <- c(0, 0, 7, 7, 0)
...
write.table(all.cell.df,
            file="/mnt/scratcha/jmlab/morgan02/FACS/Milieu_Interieur/summary_files/Panel9B_bootstrap.txt",
