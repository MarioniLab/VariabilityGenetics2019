...
P4.flow.data <- P4.flow.data[323:644]
...
viability.points <- c(0, 0, 8.5, 8.5, 0, 0)
...
write.table(all.cell.df,
            file="/mnt/scratcha/jmlab/morgan02/FACS/Milieu_Interieur/summary_files/Panel4B_bootstrap.txt",
