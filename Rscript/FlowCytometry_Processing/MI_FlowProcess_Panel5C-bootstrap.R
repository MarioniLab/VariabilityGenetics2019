...
P5.flow.data <- P5.flow.data[641:959]
...
ssc.points <- c(0, 1.5e5, 1.75e5, 1.75e5, 1.5e5, 1e5, 7.5e4, 0)
...
ssc.points <- c(1e5, 1.5e5, 2.5e5, 2.5e5, 1e5)
...
write.table(all.cell.df,
            file="/mnt/scratcha/jmlab/morgan02/FACS/Milieu_Interieur/summary_files/Panel5C_bootstrap.txt",
