...
print("Panel 1A 201-222, 224-326")
...
#subset into group A -  skip sample 223 as it is causing issues
P1.flow.data <- P1.flow.data[c(201:222, 224:326)]
...
write.table(all.cell.df,
            file="/mnt/scratcha/jmlab/morgan02/FACS/Milieu_Interieur/summary_files/Panel1A2_summary.txt",
